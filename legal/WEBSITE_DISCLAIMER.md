...
Tento dokument obsahuje **krátké disclaimery a právní texty** pro různá místa na webu ClaimBuddy:
- Footer (patička)
...
```
ClaimBuddy poskytuje asistenční služby při řešení pojistných událostí.
NEJSME pojišťovací zprostředkovatel ani advokátní kancelář.
Konečné rozhodnutí o výši plnění vždy dělá pojišťovna, ne ClaimBuddy.
```

### Varianta B: Dlouhá (1 odstavec)

```
ClaimBuddy s.r.o. poskytuje asistenční služby při řešení pojistných
...
ClaimBuddy neručí za výsledek řízení.
```
...
<footer>
  <div class="footer-content">
    ...
    <div class="footer-column">
      <h4>Kontakt</h4>
      <p>
        Email: info@claimbuddy.cz<br>
        Telefon: [doplnit]<br>
        GDPR: gdpr@claimbuddy.cz<br>
        Reklamace: reklamace@claimbuddy.cz
      </p>
    </div>
  ...
  <div class="footer-bottom">
    <p>
      © 2026 ClaimBuddy s.r.o. Všechna práva vyhrazena.
...
<div class="modal" id="case-submission-warning">
  ...
  <p>
    <strong>Důležité:</strong> ClaimBuddy nemůže ovlivnit rozhodnutí pojišťovny.
...
<div class="modal" id="claim-rejected">
  ...
  <p>
    ...
    ClaimBuddy bohužel nemůže změnit rozhodnutí pojišťovny.
  </p>
  ...
  <p class="fine-print">
    <small>
      * Výše plnění určuje pojišťovna na základě pojistných podmínek.
      ClaimBuddy negarantuje úspěch ani konkrétní výši plnění.
    </small>
  </p>
</section>
```
...
<section class="testimonials">
  ...
  <div class="testimonial">
    <blockquote>
      "Díky ClaimBuddy jsem dostal 45 000 Kč z úrazového pojištění,
...
<div class="gdpr-health-consent">
  ...
  <div class="consent-box">
    ...
    <h4>Vaše práva:</h4>
    <ul>
      <li>📧 Kdykoli odvolat souhlas (email: gdpr@claimbuddy.cz)</li>
...
---
ClaimBuddy s.r.o. | IČO: [doplnit] | info@claimbuddy.cz
...
---
P.S. Rozhodnutí pojišťovny není naše vina. ClaimBuddy nemůže
...
ClaimBuddy **NEODPOVÍDÁ** za obsah těchto webů.

## 6. Technické informace

**Dostupnost webu:**
- Web může být dočasně nedostupný (údržba, výpadky)
- ClaimBuddy neručí za škody způsobené nedostupností
...
```
🔹 DISCLAIMER:
ClaimBuddy není pojišťovací zprostředkovatel ani advokátní kancelář.
Poskytujeme pouze asistenční služby. Konečné rozhodnutí dělá pojišťovna.

#pojištění #pojistnáudalost #claimbuddy
```
...
export const Disclaimer = ({ variant = 'short' }) => {
  const disclaimers = {
    ...
    medium: "ClaimBuddy poskytuje asistenční služby při řešení pojistných událostí. Nejsme pojišťovací zprostředkovatel ani advokátní kancelář. Konečné rozhodnutí o výši plnění dělá pojišťovna.",
    long: "ClaimBuddy s.r.o. poskytuje asistenční služby při řešení pojistných událostí – pomáháme s dokumentací, komunikací s pojišťovnami a reklamacemi. NEJSME pojišťovací zprostředkovatel ve smyslu zákona o distribuci pojištění (nemáme licenci ČNB) a NEJSME advokátní kancelář (neposkytujeme právní zastoupení před soudem). Konečné rozhodnutí o uznání nebo zamítnutí pojistné události a o výši plnění vždy činí pojišťovna na základě pojistných podmínek. ClaimBuddy neručí za výsledek řízení."
  };
