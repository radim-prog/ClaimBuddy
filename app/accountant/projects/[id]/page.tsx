...
export default function ProjectDetailPage({ params }: { params: { id: string } }) {
  ...
  if (error || !project) {
    return (
      <div className="text-center py-12">
        ...
        <Button variant="outline" onClick={() => { window.location.href = '/accountant/work?type=projects' }}><ArrowLeft className="mr-2 h-4 w-4" />Zpet</Button>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-6 space-y-6">
      ...
      <div className="mb-2">
        <Button variant="ghost" size="sm" onClick={() => { window.location.href = '/accountant/work?type=projects' }} className="mb-3 rounded-xl text-gray-500 hover:text-gray-700">
