    ...
    <div className="max-w-7xl">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold font-display text-gray-900 dark:text-white">Projekty</h1>
        ...
        {filteredProjects.length === 0 ? (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <h3 className="text-lg font-semibold font-display text-gray-900 dark:text-white mb-2">Žádné projekty</h3>
          ...
          filteredProjects.map((project) => {
            ...
            return (
              <Link key={project.id} href={`/accountant/projects/${project.id}`}>
                <Card className={`card-hover transition-all cursor-pointer border-l-4 ${config.borderColor}`}>
