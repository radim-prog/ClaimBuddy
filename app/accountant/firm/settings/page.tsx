      ...
      <Card className="shadow-soft">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="billing_day" className="text-xs text-gray-500">Den fakturace (1-28)</Label>
              <Input
                id="billing_day"
                type="number"
                min={1}
            ...
            <div>
              <Label htmlFor="payment_due_days" className="text-xs text-gray-500">Splatnost (dní)</Label>
              <Input
                id="payment_due_days"
                type="number"
                min={1}
            ...
            <div>
              <Label htmlFor="penalty_rate" className="text-xs text-gray-500">Penále za den (%)</Label>
              <Input
                id="penalty_rate"
                type="number"
                min={0}
            ...
            <div>
              <Label htmlFor="currency" className="text-xs text-gray-500">Měna</Label>
              <Input
                id="currency"
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Label htmlFor="dunning_enabled" className="text-xs text-gray-500">Aktivní</Label>
              <Switch
                id="dunning_enabled"
