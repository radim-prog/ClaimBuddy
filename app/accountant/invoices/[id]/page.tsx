...
export default function InvoiceDetailPage() {
  ...
  if (!invoice) {
    return (
      <div className="max-w-4xl mx-auto py-12 text-center">
        ...
        <h2 className="text-xl font-semibold font-display text-gray-900 dark:text-white mb-2">Faktura nenalezena</h2>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-display">Položky faktury</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full">
              ...
              <tbody>
                {invoice.items.map((item, i) => (
                  <tr key={item.id} className={`border-b border-border/50 ${i % 2 === 1 ? 'bg-gray-50 dark:bg-gray-800/30' : ''}`}>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-display">Akce</CardTitle>
        </CardHeader>
        <CardContent>
