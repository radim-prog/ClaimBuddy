...
import {
  Grid3x3, Bell, CheckSquare, History, ArrowRight, Upload, Eye, Lock,
} from 'lucide-react'

export const metadata: Metadata = {
  title: 'Měsíční uzávěrky — Přehled podkladů na jeden pohled',
  description:
    'Barevná matice místo Excel tabulek. Vidíte stav všech klientů, automatické připomínky, hromadné akce.',
  openGraph: {
    title: 'Měsíční uzávěrky',
    description: 'Přehled podkladů na jeden pohled. Barevná matice místo Excel tabulek.',
    type: 'website',
  },
}

const BENEFITS = [
  { icon: Grid3x3, title: 'Matice stavu', desc: 'Všichni klienti × všechny měsíce na jedné obrazovce. Barvy okamžitě ukáží, co chybí a co je hotové.' },
  { icon: Bell, title: 'Automatické připomínky', desc: 'Systém sám upozorní klienty, kteří ještě nedodali podklady. Vy nemusíte posílat emaily ručně.' },
  { icon: CheckSquare, title: 'Hromadné akce', desc: 'Označte více klientů a proveďte akci najednou — schválení, odeslání připomínky nebo uzavření měsíce.' },
  { icon: History, title: 'Historický přehled', desc: 'Kompletní historie uzávěrek. Podívejte se zpětně, jak jednotlivé měsíce probíhaly.' },
]

const STEPS = [
  { icon: Upload, title: 'Klienti nahrají podklady', desc: 'Klienti nahrávají doklady přímo do svého portálu. Vy vidíte stav v reálném čase.' },
  { icon: Eye, title: 'Vidíte stav v matici', desc: 'Barevná matice ukáže, kdo má hotovo, kdo ještě čeká a kde jsou problémy.' },
  { icon: Lock, title: 'Uzavřete měsíc jedním klikem', desc: 'Když je vše v pořádku, uzavřete měsíc a archivujte podklady.' },
]
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-purple-50 to-white dark:from-gray-900 dark:to-gray-950 py-16 sm:py-24">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            Přestaňte sledovat podklady v tabulkách. Vidíte stav všech klientů
            na jedné obrazovce — okamžitě víte, co chybí.
          </p>
          <div className="mt-8">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold font-display tracking-tight text-foreground">
              Uzávěrky pod kontrolou
            </h2>
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Přehledný systém, který vám ušetří hodiny práce každý měsíc.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-purple-600 to-violet-600 relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold font-display tracking-tight text-white max-w-2xl mx-auto">
            Mějte uzávěrky pod kontrolou
          </h2>
          <p className="mt-4 text-lg text-white/80 max-w-xl mx-auto">
            Zaregistrujte se a vyzkoušejte přehlednou matici uzávěrek na 30 dní zdarma.
          </p>
          <div className="mt-10">
