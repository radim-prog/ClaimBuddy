...
const ACCOUNTANT_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Fakturace klientům', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Hodnocení klientů', included: true },
      { name: 'Znalostní báze', included: true },
      { name: 'Editor zavedení klienta', included: true },
      { name: 'Admin panel', included: true },
      { name: 'Raynet CRM synchronizace', included: true },
