...
const CATEGORY_COLORS: Record<AssetCategory, string> = {
  vehicle: 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300',
  electronics: 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300',
  real_estate: 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300',
  machinery: 'bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300',
  equipment: 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300',
  other: 'bg-yellow-100 text-yellow-700 dark:text-yellow-400',
}
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-2">
          <h4 className="font-medium text-sm text-gray-700 dark:text-gray-200 border-b pb-1">Finanční údaje</h4>
          <div className="text-sm space-y-1">
            <div className="flex justify-between">
              <span className="text-gray-500 dark:text-gray-400">Pořizovací cena:</span>
              <span className="font-medium">{formatCurrency(asset.acquisition_price)}</span>
            </div>
            {asset.current_value !== undefined && (
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Zůstatková hodnota:</span>
        ...
        {asset.category === 'vehicle' && asset.vehicle_details && (
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-gray-700 dark:text-gray-200 border-b pb-1">Vozidlo</h4>
            <div className="text-sm space-y-1">
              <div className="flex justify-between">
              ...
              {asset.vehicle_details.mileage && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Najeto:</span>
        ...
        {asset.category === 'vehicle' && asset.vehicle_details && (
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-gray-700 dark:text-gray-200 border-b pb-1">Termíny</h4>
            <div className="text-sm space-y-1">
              ...
              {asset.vehicle_details.stk_until && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">STK do:</span>
                  <span>{formatDate(asset.vehicle_details.stk_until)}</span>
                </div>
              )}
              {asset.vehicle_details.insurance_until && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Pojištění do:</span>
        ...
        {asset.category === 'electronics' && asset.electronics_details && (
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-gray-700 dark:text-gray-200 border-b pb-1">Elektronika</h4>
            <div className="text-sm space-y-1">
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Výrobce:</span>
              ...
              {asset.electronics_details.warranty_until && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Záruka do:</span>
        ...
        {asset.category === 'real_estate' && asset.real_estate_details && (
          <div className="space-y-2 col-span-2">
            <h4 className="font-medium text-sm text-gray-700 dark:text-gray-200 border-b pb-1">Nemovitost</h4>
            <div className="text-sm space-y-1">
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Typ:</span>
              ...
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Adresa:</span>
                <span>{asset.real_estate_details.address}</span>
              </div>
              {asset.real_estate_details.area_m2 && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Plocha:</span>
                  <span>{asset.real_estate_details.area_m2} m²</span>
                </div>
              )}
              {asset.real_estate_details.land_registry_number && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">LV:</span>
        ...
        {asset.category === 'machinery' && asset.machinery_details && (
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-gray-700 dark:text-gray-200 border-b pb-1">Stroj</h4>
            <div className="text-sm space-y-1">
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Typ:</span>
              ...
              {asset.machinery_details.power_kw && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Výkon:</span>
        ...
        {asset.category === 'equipment' && asset.equipment_details && (
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-gray-700 dark:text-gray-200 border-b pb-1">Vybavení</h4>
            <div className="text-sm space-y-1">
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Typ:</span>
              ...
              {asset.equipment_details.quantity && asset.equipment_details.quantity > 1 && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Počet:</span>
                  <span>{asset.equipment_details.quantity} ks</span>
                </div>
              )}
              {asset.equipment_details.location && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Umístění:</span>
        ...
        {asset.category === 'other' && asset.custom_fields && asset.custom_fields.length > 0 && (
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-gray-700 dark:text-gray-200 border-b pb-1">Vlastní údaje</h4>
            <div className="text-sm space-y-1">
  ...
  const renderAssetCard = (asset: Asset, isInactive = false) => (
    <div
      ...
      className={`border rounded-lg overflow-hidden transition-all ${
        isInactive ? 'border-gray-200 dark:border-gray-700 opacity-60' : 'border-gray-200 dark:border-gray-700'
      }`}
    >
      {/* Hlavní řádek */}
      <div
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-medium text-gray-900 dark:text-white">
                {asset.name}
                {isInactive && (
                  <Badge variant="outline" className="ml-2 text-gray-500 dark:text-gray-400">
