...
const CLIENT_MODULES: ModuleDef[] = [
  {
    ...
    description: 'Doklady, faktury a ucetni prehled',
    crossSellTitle: 'Potrebujete ucetni?',
    crossSellMessage: 'Zajistime vam profesionalni ucetni sluzby. Kompletni vedeni ucetnictvi, dane a poradenstvi.',
    crossSellCta: 'Zjistit vice',
    crossSellHref: '/client/dashboard',
  },
  {
    id: 'claims',
    name: 'Pojistne udalosti',
    href: '/client/claims',
    icon: Shield,
    color: 'text-blue-400',
    activeColor: 'bg-blue-500/20 text-blue-300',
    bgGradient: 'from-blue-400 to-blue-500',
    description: 'Sprava a sledovani pojistnych udalosti',
    crossSellTitle: 'Resite pojistnou udalost?',
    crossSellMessage: 'Muzeme vam pomoci s resenim pojistne udalosti. Nahlasite ji a my se o vse postarame.',
    crossSellCta: 'Nahlasit udalost',
